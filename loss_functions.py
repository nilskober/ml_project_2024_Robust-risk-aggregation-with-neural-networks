...
def loss_function_empirical_integral(inputs, outputs, rho, gamma, f, input_dim, c=partial(torch.norm, p=2, dim=1)):
    ...
    inner_arg = f(inputs_y) - inner_sum_h - outputs['lambda']*c(inputs_x - inputs_y) - outputs['g'].reshape((-1,))
